...
void StartAdvData()
{
  uint8_t stLen;
  uint8_t index = 0;
  uint8_t adv_data[25]; //max 25 bytes
 
  //-------------------------
  // Advertising Packet　　iBeacon
  //-------------------------
  // AD Structure 1 (Flags)
//  adv_data[index++] = 0x02;//0                       // field length
//  adv_data[index++] = 0x01;//1                       // AD Type
//  adv_data[index++] = 0x06;//2                       // Flag
//
//  // AD Structure 2 
//  adv_data[index++] = 0x1A;//3  // field length 残りの長さは26バイトと定義している
//  
//  adv_data[index++] = 0xFF;//4  // AD Type 
    
  adv_data[index++] = 0x4C;//5  // Company ID(2byte) Apple
  adv_data[index++] = 0x00;//6
  
  adv_data[index++] = 0x02;//7  // Beacon Type  
   
  adv_data[index++] = 0x15;//8  // iBeacon length　残りの長さは21バイトと定義している
  
  adv_data[index++] = 0x22;//9  // UUID(16byte)
  adv_data[index++] = 0x22;//10
  adv_data[index++] = 0x22;//11
  adv_data[index++] = 0x22;//12
  adv_data[index++] = 0x22;//13
  adv_data[index++] = 0x22;//14
  adv_data[index++] = 0x22;//15
  adv_data[index++] = 0x22;//16
  adv_data[index++] = 0x22;//17
  adv_data[index++] = 0x22;//18
  adv_data[index++] = 0x22;//19
  adv_data[index++] = 0x22;//20
  adv_data[index++] = 0x22;//21
  adv_data[index++] = 0x22;//22
  adv_data[index++] = 0x22;//23
  adv_data[index++] = 0x22;//24

  adv_data[index++] = 0x22;//25  // Major(2byte) 8721
  adv_data[index++] = 0x11;//26
  
  adv_data[index++] = 0x11;//27  // Minor(2byte) 4369
  adv_data[index++] = 0x11;//28
  
  adv_data[index++] = 0xC5;//29  // TxPower(1byte)



  
  Serial.println(sizeof(adv_data));
